...
local Utility = {}
local Objects = {}
function KavoCustom:DraggingEnabled(frame, parent)
...
local themeStyles = {
    ...
    Religion = {
        SchemeColor = Color3.fromRGB(102, 0, 255),
        Background = Color3.fromRGB(0, 0, 0),
        Header = Color3.fromRGB(0, 0, 0),
        TextColor = Color3.fromRGB(255, 255, 255),
...
local Name = "KavoCustomConfig.JSON"
...
function KavoCustom.CreateLib(kavName, themeList)
    ...
    elseif themeList == "fortune.lua" then
        themeList = themeStyles.fortune.lua
    ...
    table.insert(KavoCustom, kavName)
    ...
    KavoCustom:DraggingEnabled(MainHeader, Main)
    ...
    function KavoCustom:ChangeColor(prope,color)
