...
do
  local Core = loadstring(game:HttpGet("https://raw.githubusercontent.com/dsfgtyuajkvujk/xvxvxvxvxvxvx/refs/heads/main/Core.lua"))
  if not Core then return warn("Failed to load the fortune.lua Core") end
  Core()
end
